...
\subtitle{stopping for one breath, for one clear thought.}
...
\ifdesktopversion
%\desktopCover{\includegraphics[height=\paperheight]{./desktop-cover-pocket-en.png}}
...
%\input{./manuscript/tex/06-ocean-en.tex}
